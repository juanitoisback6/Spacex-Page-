...
<h2 className="rocketTitle">Falcon 9</h2>
...
<section className="starcontainer">
          ...
          <div className="rocketPartimg">
            <AnimarAlScroll>
                    ...
                    <img  
                    src="/falcon9short.png" alt="Falcon 9 image" />
          ...
          <div className="rocketInfoPart">
            ...
            <AnimarAlScroll>
                    ...
                    <h2 className="rocketInfoPartTittle"> Falcon 9 </h2>
...
<AnimarAlScroll> 
  ...
  <source src="/landingFalcon9.mp4" type="video/mp4" />
  <p>
    Your browser doesn't support HTML video.  
  </p>
</video>
